...
pub fn compress_chunk(
    ...
    let (compression_method, compressed_data) = match method {
        RecommendedMethod::PredictorRans => {
            ...
            //
            // Skip BWT for high-entropy chunks (>6.5 bps) — suffix array
            // construction is expensive and BWT clustering provides minimal
            // benefit on near-random data.  Text is typically 4-5 bps.
